            ...
            do
            {
                ...
                switch (entradaUsuario)
                {
                    ...
                    case 4:
                        ...
                        {
                            case "blanca":
                                inventario.GetElectrodomesticos().FindAll(e => e.GetType() == typeof(Blanca)).
                                    OrderBy(e => e.Nombre).ToList().ForEach(e => Console.WriteLine(e));
                                break;
                            case "gris":
                                inventario.GetElectrodomesticos().FindAll(e => e.GetType() == typeof(Gris)).
                                    OrderBy(e => e.Nombre).ToList().ForEach(e => Console.WriteLine(e));
                                break;
                            case "marron":
                                inventario.GetElectrodomesticos().FindAll(e => e.GetType() == typeof(Marron)).
                                    OrderBy(e => e.Nombre).ToList().ForEach(e => Console.WriteLine(e));
                                break;
                            case "pae":
                                inventario.GetElectrodomesticos().FindAll(e => e.GetType() == typeof(Pae)).
                                    OrderBy(e => e.Nombre).ToList().ForEach(e => Console.WriteLine(e));
                                break;
                            default:
                                break;
